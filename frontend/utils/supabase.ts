...
export const getLastRouletteNumbers_DEPRECATED = async (limit = 20) => {
...
export const insertRouletteNumber_DEPRECATED = async (number: number, customTimestamp?: string) => {
...
export const processNumbersInput_DEPRECATED = async (numbersText: string) => {
  ...
  const recentNumbers = await getLastRouletteNumbers_DEPRECATED(5);
  ...
  if (/^\d+$/.test(numbersText.trim())) {
    ...
    try {
      const result = await insertRouletteNumber_DEPRECATED(singleNumber);
...
export const getRouletteStats_DEPRECATED = async () => {
  try {
...
export const getRouletteNumberSequences_DEPRECATED = async (limit = 100) => {
  try {
...
export const obtenerEstadoBaseDatos_DEPRECATED = async () => {
  try {
...
export const ejecutarPurgaManual_DEPRECATED = async (mantenerHoras = 48, mantenerMinimo = 50) => {
  try {
...
export const verificarNecesidadPurga_DEPRECATED = async () => {
  try {
    const estado = await obtenerEstadoBaseDatos_DEPRECATED();
...
export const formatearEstadoDb_DEPRECATED = (estadoRaw: any) => {
...
export const forceInsertNumber_DEPRECATED = async (number: number) => {
...
export const forceInsertMultipleNumbers_DEPRECATED = async (numbersText: string) => {
...
export const getAnalyzerState_DEPRECATED = async () => {
  try {
...
export const updateAnalyzerState_DEPRECATED = async (updates: any) => {
  try {
...
export const checkApiHealth_DEPRECATED = async () => {
  try {
